...
<<<<<<< Updated upstream
         ...
         const userData = [
            { brugerid: TEACHER, login: "p", password: "", email: "abc@def.com", name: "pernille"},
            { brugerid: STUDENT, login: "dude", password: "ho", email: "du@de.com", name: "nilleper"}
...
TEACHER, username: 
"p", password: 
"47DEQpj8HBSa+/TImW+5JCeuQeRkm5NMpJWZG3hSuFU=", email: 
  "abc@def.com"
}
, 
{ 
...
request.onupgradeneeded = function(event) {
  ...
  var objectStoreAnswers = db.createObjectStore("answers", { 
  autoIncrement : 
    true
  }
  );
  ...
  var objectStoreQuestions = db.createObjectStore("questions", { 
  autoIncrement : 
    true
  }
  );
  ...
  /* Generate question table */
  var objectStoreTest = db.createObjectStore("test", { 
  autoIncrement : 
    true
  }
  );
